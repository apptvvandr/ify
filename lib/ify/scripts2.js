...
function Player( element ) {
	...
	this.init = function ( element ) {
		...
		//console.log("me element is:")
		//console.log(me.media)
		//this.player = me.media;
	...
	this.play_file = function (file) {
		this.player.setSrc(file);
		this.player.play();
	}
	this.toggle_lecture =function () {
...
$('#btn_play').on('click', function (e) {
	console.log(ify_player.paused);
	ify_player.toggle_lecture();
...
var ify_player = new Player($('#me_player'))
